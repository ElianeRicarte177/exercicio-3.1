...
**Aluno:** Eliane Ricarte  
**Disciplina:** IDP-TD 2026  
**Turma:** TD-2026-01  
**Serviço escolhido:** Contratação do FIES (Fundo de Financiamento Estudantil) pelo portal acesso.gov.br — MEC/FNDE  
...
- [B_relatorio_assistente_v1.md](B_relatorio_assistente_v1.md) — pesquisa original do assistente 1 (Gemini Deep Research) sobre como o FIES opera hoje
- [B_relatorio_auditoria_v1.md](B_relatorio_auditoria_v1.md) — auditoria da v1 pelo assistente 2 (ChatGPT)
...
- [C_grill_transcript.md](C_grill_transcript.md) — transcript integral da sessão de entrevista adversarial (8 rodadas)
- [C_blueprint_asis.md](C_blueprint_asis.md) — Service Blueprint AS-IS com 5 camadas, 5 etapas e fail points identificados

### Parte D — Diagrama
- [D_diagrama_asis.md](D_diagrama_asis.md) — diagrama mermaid da jornada com relações explícitas entre atores e etapas
